...
<body>
    <style>
        ...
        .scroll-text {
            ...
            padding-left: 100%; /* đẩy chữ ra ngoài khung ban đầu */
        ...
        .menu a:hover {
            background: #2e8b57; /* màu nền khi hover */
...
<body>
    ...
    <div class="menu">
        ...
        <a href="#" onclick="loadPage(event, 'https://www.w3schools.com/html/default.asp')" target="giaodien">HTML</a>
        <a href="#">CSS</a>
        <a href="#">PHP</a>
        <a href="#">JavaScript</a>
        <a href="#">W3Schools</a>
